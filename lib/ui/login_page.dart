...
import 'package:toko_pintar/bloc/login_bloc.dart';
import 'package:toko_pintar/helpers/user_info.dart';
import 'package:toko_pintar/ui/produk_page.dart';
import 'package:toko_pintar/ui/registrasi_page.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Colors.transparent, title: Text("Login")),
